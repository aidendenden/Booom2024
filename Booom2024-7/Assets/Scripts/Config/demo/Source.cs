...
namespace cfg.demo
{
public sealed partial class Source : Luban.BeanBase
{
    public Source(JSONNode _buf) 
    {
    ...
    public static Source DeserializeSource(JSONNode _buf)
    {
        return new demo.Source(_buf);
    }
    ...
    public const int __ID__ = -882301274;
