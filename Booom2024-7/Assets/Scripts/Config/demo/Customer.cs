...
namespace cfg.demo
{
public sealed partial class Customer : Luban.BeanBase
{
    public Customer(JSONNode _buf) 
    {
        ...
        { if(!_buf["hateLine"].IsString) { throw new SerializationException(); }  HateLine = _buf["hateLine"]; }
        { if(!_buf["loveLine"].IsString) { throw new SerializationException(); }  LoveLine = _buf["loveLine"]; }
    ...
    public static Customer DeserializeCustomer(JSONNode _buf)
    {
        return new demo.Customer(_buf);
    }
    ...
    /// 厌恶台词
    /// </summary>
    public readonly string HateLine;
    /// <summary>
    /// 喜爱台词
    /// </summary>
    public readonly string LoveLine;
    /// <summary>
    /// 白
    /// </summary>
    ...
    public const int __ID__ = 1371850665;
